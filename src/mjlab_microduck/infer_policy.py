...
# Repo-level mjcf/ dir; not imported from microduck_constants (see BAM note below).
_ROBOT_DIR = Path(__file__).resolve().parents[2] / "mjcf"
...
def main():
    ...
    parser.add_argument("--scene", type=str, default=None, help="Path to a scene XML, overriding the default pick (e.g. mjcf/scene_allcollisions.xml)")
