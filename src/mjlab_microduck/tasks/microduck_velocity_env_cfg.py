...
def make_microduck_velocity_env_cfg(
    ...
    cfg.rewards["air_time"].params["threshold_min"] = 0.06  # Increased from 0.02 to enforce slower steps
    ...
    cfg.rewards["action_rate_l2"].weight = -0.5  # 0.5 worked but was too fast
