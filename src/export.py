# The ONE path from checkpoint to deployable .onnx: export_policy_to_onnx emits
# actor(normalizer(obs)), so the robot runs what training saw. In-sim play applies the normalizer
# itself and therefore hides a hand-converted checkpoint that omits it. Never convert by hand.
