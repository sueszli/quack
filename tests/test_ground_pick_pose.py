import torch
from mjlab_microduck.mdp import phase_pose_blend
...
from mjlab_microduck.mdp import phase_pose_track, phase_pose_track_l1
...
class _FakeAsset:
    ...
    def find_joints(self, query):
        # mjlab returns (ids, names); we only handle the [name] query
        (name,) = query
...
def test_ground_pick_cmd_cfg_has_randomize_phase_default_true():
    from mjlab_microduck.mdp import GroundPickPhaseCommandCfg
