...
def test_crouch_height_target_endpoints_are_high():
    # phase 0 (start) and phase ~1 (end) → high height (standing)
...
def test_crouch_height_target_descent_midpoint():
    # middle of the descent (phase = hold_lo/2 = 0.1875) → midpoint of the two heights
...
def test_crouch_height_target_rise_midpoint():
    # middle of the rise (phase = 0.8125) → midpoint of the two heights
...
def test_blend_descent_and_rise_midpoints():
    # mid descent (0.05 on [0,0.1)) → 0.5 ; mid rise (0.55 on [0.5,0.6)) → 0.5
