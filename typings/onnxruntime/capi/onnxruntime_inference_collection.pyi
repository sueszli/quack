...
class Session:
    ...
    def set_ep_dynamic_options(self, options: dict[str, str]): # -> None:
        """
...
class ModelCompiler:
    ...
    def compile_to_stream(self, write_function: Callable[[bytes], None]): # -> None:
        """
...
class OrtValue:
    ...
    @classmethod
    def ortvalue_from_numpy(cls, numpy_obj: np.ndarray, /, device_type=..., device_id=..., vendor_id=...) -> OrtValue:
        """
    ...
    @classmethod
    def ortvalue_from_shape_and_type(cls, shape: Sequence[int], element_type, device_type: str = ..., device_id: int = ..., vendor_id: int = ...) -> OrtValue:
        """
...
def copy_tensors(src: Sequence[OrtValue], dst: Sequence[OrtValue], stream=...) -> None:
    """
...
class OrtDevice:
    ...
    @staticmethod
    def make(ort_device_name, device_id, vendor_id=...): # -> OrtDevice:
        ...
...
GetInitializerLocationFunc = Callable[[str, OrtValue, C.OrtExternalInitializerInfo | None], C.OrtExternalInitializerInfo | None]
GetInitializerLocationWrapperFunc = Callable[[str, C.OrtValue, C.OrtExternalInitializerInfo | None], C.OrtExternalInitializerInfo | None]
